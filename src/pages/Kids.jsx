  ...
  return (
    <div>
      <HeroSection
        ...
        img4="https://prod-img.thesouledstore.com/public/theSoul/storage/mobile-cms-media-prod/banner-images/web-banner_nwuMPZV.jpg?format=webp&w=1500&dpr=1.3"
        img5="https://prod-img.thesouledstore.com/public/theSoul/storage/mobile-cms-media-prod/banner-images/homepage-banner_8_gISg7qE.jpg?format=webp&w=1366&dpr=1.0"
        img6="https://prod-img.thesouledstore.com/public/theSoul/storage/mobile-cms-media-prod/banner-images/web-banner_nwuMPZV.jpg?format=webp&w=1500&dpr=1.3"
      />
      ...
      {kids.map((value) => {
        return <CategoryCard value={value} />;
      })}
    </div>
  );
}
